...
?>
	...
	<option <?php if($this->motorsport->msupdate_cachse=='12') { echo "selected='selected'"; } ?> value="12">12 hours</option>
			...
			<tr><td colspan="2">For more details, view the API documentation at <a href="http://api.motorsportreg.com" target="_blank">http://api.motorsportreg.com</a></td></tr>
			<tr><td colspan="2"><strong>PLEASE subscribe</strong> to our developer group at <a href="https://groups.google.com/forum/#!forum/motorsportreg-api-developers" target="_blank">https://groups.google.com/forum/#!forum/motorsportreg-api-developers</a></td></tr> 
			</table>
