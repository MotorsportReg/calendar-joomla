...
* @author Yogesh Arora
* @link http://joomlacode.org/gf/project/MotorSport/
...
* MotorSport Model
*/
class MotorSportModelMotorSport extends JModelItem
{
...
public function getTable($type = 'MotorSport', $prefix = 'MotorSportTable', $config = array())
{
...
$out = '<div class="msrcalendar"><h2></h2>';
$out .='<table class="msrcalendar"><thead><tr>';
$out .='<th colspan="7"><span style="float:left;"></span><span style="float:right;">To see thousands more, <a href="http://www.motorsportreg.com/calendar/" target="_blank">view the full calendar</a></span></th></tr><tr>';
$show=false;

if($field_eventdate=='1'){
$out .='<th>'.JText::_('COM_MOTORSPORT_DATE').'</th>';
$show=true;
}

if($field_eventname=='1'){
$out .='<th>'.JText::_('COM_MOTORSPORT_NAME').'</th>';
$show=true;
}

if($field_organization=='1'){
$out .='<th>'.JText::_('COM_MOTORSPORT_ORGANIZATION').'</th>';
$show=true;
}

if($field_venue=='1'){
$out .='<th>'.JText::_('COM_MOTORSPORT_VANUE').'</th>';
$show=true;
}

if($field_venuecity=='1'){
$out .='<th>'.JText::_('COM_MOTORSPORT_LOCATION').'</th>';
$show=true;
}

if($field_eventtype=='1'){
$out .='<th>'.JText::_('COM_MOTORSPORT_TYPE').'</th>';
$show=true;
}
